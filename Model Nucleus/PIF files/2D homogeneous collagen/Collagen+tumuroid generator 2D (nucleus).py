...
output_file = "C:\\users\\roysc\\downloads\\ru-modellenpracticum-master\\ru-modellenpracticum-master\\Model\\PIF files/2d collagen1000 nucleus.piff" # make sure to use the right path
lattice_dim = 400  # width and height of the lattice
no_of_fibres_per_direction = 1000  # total number: twice this number (in x and y directions)
fibre_ratio = 2
...
with open(output_file, 'w') as f:
    ...
    f.write("0 0 Medium 0 " + str(lattice_dim - 1) + " 0 " + str(lattice_dim - 1) + " 0 0\n")
