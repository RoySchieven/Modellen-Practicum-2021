...
output_file = "./3d collagen60000test2.piff"
...
with open(output_file, 'w') as f:
    ...
    for cell_id in range(1 + no_of_fibres_per_direction_ld, 2 * no_of_fibres_per_direction_ld + 1):
        # Choose random position
    ...
    for cell_id in range(1 + no_of_fibres_per_direction_cleft, 2 * no_of_fibres_per_direction_cleft + 1):
        x = random.randint(0, lattice_dim - 1)
    ...
    for cell_id in range(1 + no_of_fibres_per_direction_hd, 2 * no_of_fibres_per_direction_hd + 1):
        x = random.randint(0, lattice_dim - 1)
        y = random.randint(0, (lattice_dim/2)-cleft_hight-fibre_length+1)
        z = random.randint(0, lattice_dim - 1)
